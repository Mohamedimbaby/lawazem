...
import 'OnBoarding/OnBoardingWidget.dart';
      ...
      child:  BlocBuilder<LanguageBloc , LanguageState >(
          builder: (context , state ){
           // SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(  statusBarColor: MAIN_COLOR,statusBarBrightness: Brightness.light));
            debugPrint(state.locale !=null ? state.locale!.languageCode:"en");
            if (SharedPref.getLang()==null || state.locale!=null) {

              SharedPref.saveLang(state.locale != null
            ...
            return  ScreenUtilInit(
                ...
                builder: ()=> MaterialApp(
                    ...
                    locale:  state.locale ?? Locale(SharedPref.getLang()!,""),
                    theme: ThemeData(
                      primaryColor: MAIN,
                    ).copyWith(
