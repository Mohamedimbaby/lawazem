...
class _AccountScreenState extends State<AccountScreen> {
            ...
            Column(
              children: [
                ...
                GestureDetector(
                  child: buildListItem(
                      AppConfig.locality == Locality.arabic
                          ? AppConfig.labels!.arabicLanguage
                          : AppConfig.labels!.english,
                      image: ImagePaths.LANG),
                  onTap: () {
                    print("tapped");
                    showDialog(
                        context: context,
                        builder: (c) {
                          return Directionality(
                            textDirection: AppConfig.locality == Locality.arabic
                                ? TextDirection.rtl
                                : TextDirection.ltr,
                            child: AlertDialog(
                                title: Text(
        ...
        Container(
          ...
          decoration: BoxDecoration(
              ...
              image: DecorationImage(
                  image: AssetImage(ImagePaths.LOGO), fit: BoxFit.fill)),
        ),
        SizedBox(
          width: 15,
        ),
  ...
  buildCountSection() {
    return Row(
      ...
      children: [
        itemCount(AppConfig.labels!.my_orders, Icons.shopping_cart,
            AppConfig.orders.length),
        itemCount(AppConfig.labels!.favorites, Icons.favorite_rounded,
            AppConfig.likedItems.length),
      ],
    );
  }
  ...
  itemCount(String title, IconData iconData, int count) {
    return Column(
      children: [
        ...
        Text(
          count.toString(),
          style: normalText(18.sp, TEXT_COLOR),
        )
      ],
    );
  }
  ...
  buildMyWallet() {
    return Container(
      ...
      height: 120,
      decoration:
          BoxDecoration(borderRadius: BorderRadius.circular(16), color: MAIN),
      child: Column(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          Text(
            "248 " + AppConfig.labels!.sar,
            style: boldText(28.sp, Colors.white),
          ),
          Container(
    ...
    return Row(
      children: [
        Container(
          ...
          width: 50.w,
          decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(8), color: PINK_GG_COLOR),
          child: iconData != null
              ? Icon(
                  iconData,
                  color: MAIN,
