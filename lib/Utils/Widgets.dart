...
Widget myTextFormField(
    ...
    {Icon? suffixIcon,Icon? prefixIcon, }) {
  return Container(
    width: width,
    height: height,
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
          ...
          prefixText: "      ",
          suffixIconConstraints: BoxConstraints(   minHeight: 70,
            minWidth: 70,),
          prefixIconConstraints: BoxConstraints(   minHeight: 70,
            minWidth: 70,),
    ...
    child: Column(
      ...
      children: [
        Row(
          ...
          children: [
            Skeleton(height: 200,width: MyDimensions.screenWidth *.5 - 20,),
            Skeleton(height: 200,width:  MyDimensions.screenWidth *.5 - 20,),
          ],
        ),
...
Widget confirmationDialogWithOptions(String title , String description , BuildContext context , Function  onTapFirstAction, Function  onTapSecondAction)
{
  return  Dialog(
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: normalText( 12.sp , TEXT_COLOR,),
          ),
...
return  !isLiked ? Icon(Icons.favorite_border_outlined,color: GREY_COLOR, ): Icon(Icons.favorite,color: RED, );
}
  ...
  return AlertDialog(
    ...
    content: Container(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
            Image.asset(ImagePaths.CART_IMAGE, height: 150.h,width: 100,),
            SizedBox(height: 10.h,),
            Text(AppConfig.labels!.items_added_to_cart, style: boldText(16.sp, TEXT_COLOR),)
        ],
      ),
    ),
  );
   ...
   AppBar customAppBar(String title,BuildContext context) {
    return AppBar(
      leading: InkWell(
          ...
          child: Icon(Icons.arrow_back_ios_outlined , color: TEXT_COLOR,)),
      backgroundColor: WHITE,
      title: Text(title , style: semiBoldText(16.sp , TEXT_COLOR),),
      centerTitle: true,
      elevation: 0,
    );
  }
