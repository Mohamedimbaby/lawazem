...
class RegistrationRepo {
  static Future<RegistrationUser> register(RegistrationEvent event) async {
    var body =
        ...
        '"commercial_No":"${event.crNumber}","email":"hadeer.didi6@gmail.com","first_name":"Hadeer",'
        '"last_name":"Mohamed","username":"DIDI","password":"${event.password}","billing_address":'
        ...
        ':"hadeer.didi6@gmail.com","phone":"${event.mobileNumber}"},"shipping_address":{"first_name":"John",'
